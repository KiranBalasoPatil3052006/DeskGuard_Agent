...
namespace DeskGuardAgent.Constants
{
    ...
    public static class ApiRoutes
    {
        ...
        /// <summary>
        /// Endpoint for submitting change detection events.
        /// Route: /api/v1/agent/changes
        /// </summary>
        public const string ChangeDetectionEndpoint = "/api/v1/agent/changes";

        /// <summary>
        /// Endpoint for notifying backend that the agent is shutting down gracefully.
        /// Route: /api/v1/agent/heartbeat
        /// </summary>
        public const string ShutdownEndpoint = "/api/v1/agent/shutdown";

        /// <summary>
        /// Endpoint for notifying backend that the agent has been uninstalled.
        /// Called by the uninstaller before files are deleted.
        /// Route: /api/v1/agent/uninstall
        /// </summary>
        public const string UninstallEndpoint = "/api/v1/agent/uninstall";
    }
}
