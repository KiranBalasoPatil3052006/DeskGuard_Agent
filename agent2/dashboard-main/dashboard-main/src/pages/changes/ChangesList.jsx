  ...
  return (
    <div className="container-fluid p-0">
      <div className="d-flex align-items-center justify-content-between mb-4">
        ...
        <button onClick={() => refetch()} disabled={isFetching} className="btn btn-outline-secondary btn-sm rounded-pill px-3 d-flex align-items-center gap-2">
          <FaSync className={isFetching ? 'spin-animation' : ''} /> Refresh
        </button>
      </div>
