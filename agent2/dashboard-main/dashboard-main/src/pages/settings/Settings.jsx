  ...
  return (
    <div className="container-fluid p-0">
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        ...
        <div>
          <button className="btn btn-primary d-flex align-items-center" onClick={() => { Object.entries({ theme, language, dateFormat, timezone, refreshInterval, cpuThreshold, ramThreshold, diskThreshold, alertFrequency, emailAlertsEnabled, inAppAlerts }).forEach(([k, v]) => setPref(k, v)); alert('Settings saved locally.'); }}>
                ...
                <div className="fade show active">
                  ...
                  <div className="text-center py-5">
                    <p className="text-muted mb-4">
                      Alert thresholds are now managed through profiles. Create and manage profiles that define when alerts are triggered for different types of systems.
                    </p>
                    <button className="btn btn-success btn-lg px-4 d-inline-flex align-items-center gap-2"
