                ...
                await Task.Run(() =>
                {
                    ...
                    try
                    {
                        ...
                        if (netFwPolicyType != null)
                        {
                            ...
                            firewallInfo.IsDomainFirewallEnabled = fwPolicy2.IsRuleGroupCurrentlyEnabled(1);
                            firewallInfo.IsPrivateFirewallEnabled = fwPolicy2.IsRuleGroupCurrentlyEnabled(2);
                            firewallInfo.IsPublicFirewallEnabled = fwPolicy2.IsRuleGroupCurrentlyEnabled(4);
