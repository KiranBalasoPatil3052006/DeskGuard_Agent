                ...
                await Task.Run(() =>
                {
                    ...
                    foreach (Process process in processes)
                    {
                        try
                        {
                            ...
                            // CPU usage is a snapshot and may not be perfectly accurate.
                            // A more accurate approach would require tracking over time.
                            try
                            {
                                processInfo.CpuUsagePercentage = Math.Round(process.TotalProcessorTime.TotalMilliseconds / Environment.ProcessorCount, 2);
                            }
                            catch
                            {
