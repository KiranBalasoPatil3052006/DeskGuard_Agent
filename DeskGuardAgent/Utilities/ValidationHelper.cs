...
namespace DeskGuardAgent.Utilities
{
    ...
    public static class ValidationHelper
    {
        ...
        public static List<string> ValidateAgentConfiguration(Configuration.AgentSettings agentSettings)
        {
            ...
            // Validate the Tenant ID is present for multi-tenant identification.
            if (string.IsNullOrWhiteSpace(agentSettings.TenantId))
            {
                errors.Add("TenantId is not configured. Set AgentSettings:TenantId in appsettings.json.");
            }
