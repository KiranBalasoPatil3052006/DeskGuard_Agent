        ...
        public async Task<List<EventLogInfo>> CollectAsync()
        {
            ...
            try
            {
                ...
                await Task.Run(() =>
                {
                    ...
                    {
                        _logger.LogDebug("Security event log access denied (expected unless running as admin). Login activity tracking unavailable.");
                    }
                    ...
                    {
                        _logger.LogWarning("Failed to read Security event log for login activity.", ex);
                    }
                });
